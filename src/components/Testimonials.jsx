...
const testimonials = [
  ...
  { name: 'Yuki Tanaka',     role: 'CEO, Sakura Beauty Co.',    country: 'Tokyo, Japan',          text: 'Our private label launch exceeded every expectation. Our branded lashes are now our top SKU, with 3x reorder in 6 months.', order: 'Private label - 1,000 units - Human Hair', stars: 5 },
  ...
  { name: 'Natalia Kovacs',  role: 'Lash Educator & Artist',    country: 'Budapest, Hungary',     text: 'I teach 200+ students per year. MCI lashes are the only ones I recommend for training because the tapered ends make technique easy to demonstrate.', order: '150 pairs/month - Soft Touch Natural', stars: 5 },
  { name: 'Isabella Costa',  role: 'Med Spa Director',          country: 'Sao Paulo, Brazil',     text: 'When we switched to MCI Human Hair lashes, we saw a 28% increase in lash service bookings within 2 months.', order: '200 pairs/month - Classic Human Hair', stars: 5 },
]
...
function TestimonialCard({ item }) {
  return (
    <div className="t-card" style={{ position: 'relative' }}>
      ...
      <div className="t-stars"><span className="t-star">{item.stars} / 5</span></div>
    ...
    <section ref={ref} className="testimonials-section">
      ...
      <div className="container">
        <div className="t-stats-row">
          {[{ num: '1,456+', label: 'Active Contacts' }, { num: '4.9/5', label: 'Average Rating' }, { num: '30+', label: 'Countries Served' }, { num: '100%', label: 'Quality Tested' }].map((s, i) => (
