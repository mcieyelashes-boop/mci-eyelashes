...
const products = [
  ...
  { id: '08', name: 'Magnetic Lashes', tagline: 'No Glue · Reusable 30×', badge: 'Innovative', skus: 'MG 5000 – MG 5040', desc: 'Revolutionary nano-magnet technology — no adhesive needed. Snap on in seconds, remove cleanly, and reuse up to 30 times. Perfect for retail and private label.', specs: ['Nano-magnet technology', 'Reusable up to 30× wear', '40 styles available', 'Glue-free application'], moq: '100 pairs' },
